(function() {
    var SamlTestConstant = SamlTestConstant || {};

    SamlTestConstant.IDP_ENDPOINT_URL = "http://my-idp.fakedomain.int/idp/profile/SAML2/SOAP/ECP";
    SamlTestConstant.SP_RESOURCE_URL = "http://my-sp.fakedomain.int";
    SamlTestConstant.SP_SSO_URL = "http://my-sp.fakedomain.int/saml/SSO";
    ...
    SamlTestConstant.TEXT_PAOS_ACCEPT_ATTRIBUTE = 'text/html; application/vnd.paos+xml';
    SamlTestConstant.PAOS_UTF8_CONTENT_TYPE = 'application/vnd.paos+xml;charset=utf-8';
    SamlTestConstant.PAOS_HTTP_HEADER = {
        PAOS: SamlTestConstant.PAOS_ATTRIBUTE,
        Accept: SamlTestConstant.TEXT_PAOS_ACCEPT_ATTRIBUTE
    };
    ...
    <soap11:Header>\
    <paos:Request xmlns:paos="urn:liberty:paos:2003-08" responseConsumerURL="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO"\
        ...
        soap11:actor="http://schemas.xmlsoap.org/soap/actor/next" soap11:mustUnderstand="1">\
        <saml2:Issuer xmlns:saml2="urn:oasis:names:tc:SAML:2.0:assertion">' + SamlTestConstant.SP_NAME + '</saml2:Issuer>\
        </ecp:Request>\
        </soap11:Header>\
        <soap11:Body>\
        <saml2p:AuthnRequest xmlns:saml2p="urn:oasis:names:tc:SAML:2.0:protocol"\
        AssertionConsumerServiceURL="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO" ForceAuthn="false"\
    ...
    SamlTestConstant.PAOS_AUTH_SUCCESS =
        '<?xml version="1.0" encoding="UTF-8"?>\
        <soap11:Envelope xmlns:soap11="http://schemas.xmlsoap.org/soap/envelope/">\
    <soap11:Header>\
    <ecp:Response AssertionConsumerServiceURL="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO"\
    soap11:actor="http://schemas.xmlsoap.org/soap/actor/next" soap11:mustUnderstand="1"\
    ...
    <soap11:Body>\
    <saml2p:Response Destination="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO" ID="_52d4f3bc2fd1e236c40829ede867395c"\
    ...
    <xenc:EncryptedKey Id="_7f6f3bf81734e016450eaae072c4ffc8" Recipient="' + SamlTestConstant.SP_NAME + '"\
    xmlns:xenc="http://www.w3.org/2001/04/xmlenc#">\
    ...
    SamlTestConstant.PAOS_AUTH_FAILED =
        '<?xml version="1.0" encoding="UTF-8"?>\
        <soap11:Envelope xmlns:soap11="http://schemas.xmlsoap.org/soap/envelope/">\
    <soap11:Header>\
    <ecp:Response AssertionConsumerServiceURL="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO"\
    ...
    <soap11:Body>\
    <saml2p:Response Destination="' + SamlTestConstant.SP_RESOURCE_URL + '/saml/SSO" ID="_9202d16e15ace69d36df861cf37787c6"\
    ...
    define('SamlTestConstant',
        [],
        function () {
            return SamlTestConstant;
        }
    );
})();